...
def resnet_v1(input_shape, n_res_block, n_class=10):
...
def resnet_v2(input_shape, n_res_block, n_class=10):
...
if __name__ == '__main__':
    ...
    model = resnet_v1(input_shape=input_shape, n_res_block=n_res_block) if version == 1 else resnet_v2(input_shape=input_shape, n_res_block=n_res_block)
